GeneralNlModel=structure(function #The most general costructor for class NlModel
### The function creates a numerical model  for n arbitrarily connected pools.
### It is one of the constructors of class NlModel                       
### It is e.g. used by some more specialized wrapper functions like for instance \code{\link{ParallelModel}} but can also be used directly. It is in fact the most### versatile interface to produce instances of class NlModel. 

(t,			##<< A vector containing the points in time where the solution is sought.
 dC,			##<< A TimeMap object consisting of  a vector valued function describing the derivatives and a time range for which this function is valid. The number of rows of the vector must be equal to the number of pools. The time range must cover the times given in the first argument. 
 ivList,		##<< A vector containing the initial amount of carbon for the n pools. The length of this vector is equal to the number of pools and thus equal to the length of k. This is checked by the function \code{\link{correctnessOfNlModel}}.
 ...
 )
{
   ...
   obj=new(Class="NlModel",t,dC,ivList,inputFluxes,solverfunc,pass)
   return(obj)
...
,ex=function(){
      ...
      mod=GeneralNlModel(t,dC,c0,inputFluxes)
      Y=getC(mod)
      lt1=1;  lt2=2; lt3=3 

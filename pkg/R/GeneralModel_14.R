...
# inputFluxes, ##<< An object the inputs to the pools as funtions of time 
# inputFc,##<< An object describing the fraction of C_14 in per mille.
...
#   obj=new(Class="Model_14",t,A,ivList, initialValF,inputFluxes,inputFc,di,solverfunc,pass=pass)
#   return(obj)
...
#
#      mod=GeneralModel_14(t,At,c0,F0,inputFluxes,inputFc,k)
#      #start plots
#      par(mfrow=c(3,2))
#         lt1=1;  lt2=2; lt3=3 

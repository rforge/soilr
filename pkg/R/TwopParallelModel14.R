TwopParallelModel14<-structure(
    ...
    { 
      ...
      mod=GeneralModel_14(t,At,ivList=C0,initialValF=SoilR.F0.new(F0_Delta14C,"Delta14C"),inputFluxes=inputrates,Fc,di=lambda)
    ...
    ex=function(){
      ...
      Ex=TwopParallelModel14(t=years,ks=c(k1=1/2.8, k2=1/35),C0=c(200,5000), F0_Delta14C=c(0,0),In=LitterInput, gam=0.7,FcAtm=C14Atm_NH,lag=2)
      R14m=getF14R(Ex)
      C14m=getF14C(Ex)
      C14t=getF14(Ex)

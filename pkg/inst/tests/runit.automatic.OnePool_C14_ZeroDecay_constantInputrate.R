...
test.OnePool_C14_ZeroDecay_constantInputrate_c14=function(){
   ...
   Y14[,1]=0.5*c01*exp(-t*log(2)/5730) + 2865.0/log(2) - 2865.0*exp(-t*log(2)/5730)/log(2)
   F14=matrix(ncol=1,nrow=length(t))
   F14[,1]=-1000 + 1000*(0.5*c01*exp(-t*log(2)/5730) + 2865.0/log(2) - 2865.0*exp(-t*log(2)/5730)/log(2))/(c01 + t)
   mod=GeneralModel_14(
    t,
    A,
    c(
